 ...
 * @author ibo
 */
public class Newlobby extends javax.swing.JFrame {
int xMouse;
int yMouse;
      Peer pr;
    Client cli;
    /**
     * Creates new form Newlobby
     */
    public Newlobby(Peer pr) {
        this.pr = pr;
        this.cli = cli;
        initComponents();
    }
    ...
    private void minimiseButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimiseButtonMouseClicked
        this.setState(Newlobby.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Newlobby.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
